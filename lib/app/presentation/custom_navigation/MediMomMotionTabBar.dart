...
import 'MediMomMotionTabController.dart';
import 'MediMomTabItem.dart';

typedef MotionTabBuilder = Widget Function();

class MediMomMotionTabBar extends StatefulWidget {
  ...
  final MediMomMotionTabBarController? controller;
  ...
  MediMomMotionTabBar({
    ...
    this.tabIconColor = const Color.fromRGBO(186, 186, 186, 1),
    this.tabIconSize = 24,
...
class _MotionTabBarState extends State<MediMomMotionTabBar> with TickerProviderStateMixin {
                            ...
                            child: Padding(
                              ...
                              child: Opacity(
                                ...
                                child: Stack(
                                  ...
                                  children: [
                                    Image.asset(
                                      activeIcon!.replaceAll(".png", "_selected.png"),
